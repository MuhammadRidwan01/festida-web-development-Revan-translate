    ...
    <div class="flex-1 flex items-center justify-center">
        <div id="Success" class="flex flex-col items-center justify-center gap-[30px] my-auto">
            ...
            <div class="flex flex-col gap-[14px] text-center max-w-[389px]">
                ...
                <p class="leading-[26px] text-white">Kami telah menerima lamaran Anda dan perekrut akan meninjaunya dalam beberapa hari kerja</p>
            </div>
            <a href="{{route('front.index')}}" class="rounded-full p-[14px_24px] bg-[#FF6B2C] font-semibold text-white hover:shadow-[0_10px_20px_0_#FF6B2C66] transition-all duration-300">
            Jelajahi Pekerjaan Lain</a>
        </div>
    </div>
</body>
