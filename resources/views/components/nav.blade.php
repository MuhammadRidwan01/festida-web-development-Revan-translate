<nav class="container max-w-7xl mx-auto flex items-center justify-between pt-6 relative">
    ...
    <ul class="hidden lg:flex items-center gap-8">
        ...
        <li>
            <a href="{{route('front.pencarian')}}" class="relative py-2 transition-all duration-300 hover:text-[#3B82F6] text-[#1E40AF]">
                Pencarian
        ...
        <li>
            <a href="{{route('front.kategori')}}" class="relative py-2 transition-all duration-300 hover:text-[#3B82F6] text-[#1E40AF]">
                Kategori
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-[#3B82F6] transform scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span>
            </a>
        </li>
        <li>
            <a href="{{route('front.job')}}" class="relative py-2 transition-all duration-300 hover:text-[#3B82F6] text-[#1E40AF]">
                Lowongan
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-[#3B82F6] transform scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span>
            </a>
        </li>
        @auth
            <div class="flex items-center gap-4">
                <p class="username font-medium text-[#1E40AF]"><a href="{{route('dashboard')}}">Dasboard</a></p>
